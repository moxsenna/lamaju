...
- Version: Deployment Cloudflare Pages `ecc26ccb` — perbaikan copy running teks (ticker) dan penghilangan pengungkapan harga dini (pricing disajikan setelah edukasi value)
