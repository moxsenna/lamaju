(() => {
    ...
    try {
      if (typeof window.gtag === 'function') {
        window.gtag('event', 'whatsapp_click', {
          ...
          offer_name: 'Paket UMKM 48 Jam Rp299.000',
    ...
    try {
      if (typeof window.fbq === 'function') {
        window.fbq('track', 'Contact', {
          content_name: 'Paket UMKM 48 Jam Rp299.000',
          cta_location: location
        });
      }
    } catch (error) {
  ...
  const demoData = {
    food: {
      ...
      url: 'sambal-bu-rara.lajupage.site', logo: 'BU RARA', eyebrow: 'SAMBAL TERI RUMAHAN',
    ...
    service: {
      ...
      url: 'bersihin-sepatu.lajupage.site', logo: 'BERSIH.IN', eyebrow: 'LAUNDRY SEPATU ANTAR-JEMPUT',
